...
import FieldsOnMap from "./components/Field/FieldsOnMap.jsx";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/profile"
          element={
            !isAuthenticated ? <Navigate to="/login" /> : <ProfileInformation />
          }
        />
        <Route
          path="/update-password"
          element={
            !isAuthenticated ? <Navigate to="/login" /> : <UpdatePassword />
          }
        />
        <Route
        ...
        <Route
          path="/fields"
          element={
            !isAuthenticated && !isOwner ? <Navigate to="/" /> : <Fields />
          }
        />
        <Route
          path="/fieldsonmap"
          element={
            !isAuthenticated && !isOwner ? <Navigate to="/" /> : <FieldsOnMap />
          }
        />
      </Routes>
    </BrowserRouter>
