...
function TempReservations() {
    ...
    function getPlayers(reservationId) {
        axiosInstance.get(`api/temp_reservations/${reservationId}/players/`).then(response => {
    ...
    function invitePlayer(event, reservationId, playerEmail) {
        ...
        axiosInstance.patch(`api/temp_reservations/${reservationId}/players/invite/`, {
            email: playerEmail,
        }).then((response) => {
    ...
    function removePlayer(event, reservationId, playerId) {
        ...
        Confirm.show(
            ...
            'No',
            () => {
                axiosInstance.patch(`api/temp_reservations/${reservationId}/players/remove/`, {
                    id: playerId,
                }).then((response) => {
                    getPlayers(reservationId);
                    Report.success(
